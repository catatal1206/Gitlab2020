...
class ExtensionHostDebugConfigurationProvider {
    resolveDebugConfiguration(folder, debugConfiguration) {
        var _a, _b;
        const useV3 = (_b = (_a = getWithoutDefault('debug.extensionHost.useV3')) !== null && _a !== void 0 ? _a : getWithoutDefault('debug.javascript.usePreview')) !== null && _b !== void 0 ? _b : isInsiders();
        if (useV3) {
